...
//
// File           : OutTEX.java
// Description    : Permet d'imprimer un AST sous la forme d'un fichier TEX
//                  ce fichier utilisera le style B1.sty 
//
// Copyright 2000-2009 Jean-louis Boulanger


// RELEASES
// September 2000    v 0.1
//       Creation            
// October   2003    v 0.2
//       Finish the translation from AST to TEX
// April     2004    v 0.3
...
public class OutTEX extends OUT
{
    ...
    */
	...
	// 2. on a utiliser le if au lieu du switch suite au restriction 
        //    (pas de string et pas d'expressions)
