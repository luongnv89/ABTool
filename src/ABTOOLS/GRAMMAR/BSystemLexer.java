// $ANTLR 2.7.6 (2005-12-22): "expandedBSystem.g" -> "BSystemLexer.java"$
...
public class BSystemLexer extends antlr.CharScanner implements BSystemTokenTypes, TokenStream
 {
...
public BSystemLexer(InputStream in) {
	this(new ByteBuffer(in));
}
public BSystemLexer(Reader in) {
	this(new CharBuffer(in));
}
public BSystemLexer(InputBuffer ib) {
	this(new LexerSharedInputState(ib));
}
public BSystemLexer(LexerSharedInputState state) {
	super(state);
...
tryAgain:
	for (;;) {
		...
		try {   // for char stream error handling
			try {   // for lexical error handling
				...
				default:
					if ((LA(1)=='L') && (LA(2)=='E') && (LA(3)=='A') && (LA(4)=='D') && (LA(5)=='S')) {
						mB_LEADSTO(true);
						theRetToken=_returnToken;
					}
	...
	public final void mB_LEADSTO(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
	...
	public final void mML_COMMENT(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		...
		if ((LA(1)=='/') && (LA(2)=='*') && (LA(3)=='?') && ((LA(4) >= '\u0003' && LA(4) <= '\uffff')) && ((LA(5) >= '\u0003' && LA(5) <= '\uffff'))) {
			...
			_loop555:
			do {
				if (((LA(1)=='?') && (LA(2)=='*') && ((LA(3) >= '\u0003' && LA(3) <= '\uffff')) && ((LA(4) >= '\u0003' && LA(4) <= '\uffff')) && ((LA(5) >= '\u0003' && LA(5) <= '\uffff')))&&(LA(3)!='/' )) {
					match("?*");
				}
				else {
					boolean synPredMatched553 = false;
					if (((LA(1)=='/') && (LA(2)=='*') && ((LA(3) >= '\u0003' && LA(3) <= '\uffff')) && ((LA(4) >= '\u0003' && LA(4) <= '\uffff')) && ((LA(5) >= '\u0003' && LA(5) <= '\uffff')))) {
						int _m553 = mark();
...
inputState.guessing--;
					...
					else if ((_tokenSet_1.member(LA(1))) && ((LA(2) >= '\u0003' && LA(2) <= '\uffff')) && ((LA(3) >= '\u0003' && LA(3) <= '\uffff')) && ((LA(4) >= '\u0003' && LA(4) <= '\uffff')) && (true)) {
						{
						match(_tokenSet_1);
						}
					}
...
inputState.guessing--;
					...
					else if ((_tokenSet_2.member(LA(1))) && ((LA(2) >= '\u0003' && LA(2) <= '\uffff')) && ((LA(3) >= '\u0003' && LA(3) <= '\uffff')) && (true) && (true)) {
						{
						match(_tokenSet_2);
						}
					}
