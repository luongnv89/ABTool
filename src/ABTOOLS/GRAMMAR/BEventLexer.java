// $ANTLR 2.7.6 (2005-12-22): "expandedBEvent.g" -> "BEventLexer.java"$
...
public class BEventLexer extends antlr.CharScanner implements BEventTokenTypes, TokenStream
 {
...
public BEventLexer(InputStream in) {
	this(new ByteBuffer(in));
}
public BEventLexer(Reader in) {
	this(new CharBuffer(in));
}
public BEventLexer(InputBuffer ib) {
	this(new LexerSharedInputState(ib));
}
public BEventLexer(LexerSharedInputState state) {
	super(state);
	...
	literals.put(new ANTLRHashString("POST", this), new Integer(195));
	...
	literals.put(new ANTLRHashString("MAINTAIN", this), new Integer(190));
	literals.put(new ANTLRHashString("CONSTANTS", this), new Integer(136));
	literals.put(new ANTLRHashString("INT1", this), new Integer(87));
	literals.put(new ANTLRHashString("MODALITIES", this), new Integer(189));
	...
	literals.put(new ANTLRHashString("ESTABLISH", this), new Integer(192));
	literals.put(new ANTLRHashString("EXTENDS", this), new Integer(129));
	literals.put(new ANTLRHashString("ALL", this), new Integer(193));
	...
	literals.put(new ANTLRHashString("SYSTEM", this), new Integer(187));
	...
	literals.put(new ANTLRHashString("EVENTS", this), new Integer(188));
	...
	literals.put(new ANTLRHashString("UNTIL", this), new Integer(191));
	...
	public final void mB_NUMBER(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		...
		do {
			if (((LA(1) >= '0' && LA(1) <= '9'))) {
				...
				if ( _cnt651>=1 ) { break _loop651; } else {throw new NoViableAltForCharException((char)LA(1), getFilename(), getLine(), getColumn());}
			}
