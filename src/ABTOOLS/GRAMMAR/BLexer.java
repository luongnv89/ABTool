// $ANTLR 2.7.6 (2005-12-22): "expandedB.g" -> "BLexer.java"$
...
public class BLexer extends antlr.CharScanner implements BTokenTypes, TokenStream
 {
...
public BLexer(InputStream in) {
	this(new ByteBuffer(in));
}
public BLexer(Reader in) {
	this(new CharBuffer(in));
}
public BLexer(InputBuffer ib) {
	this(new LexerSharedInputState(ib));
}
public BLexer(LexerSharedInputState state) {
	super(state);
...
tryAgain:
	...
	public final void mML_COMMENT(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		...
		if ((LA(1)=='/') && (LA(2)=='*') && (LA(3)=='?') && ((LA(4) >= '\u0003' && LA(4) <= '\uffff')) && ((LA(5) >= '\u0003' && LA(5) <= '\uffff')) && ((LA(6) >= '\u0003' && LA(6) <= '\uffff')) && (true) && (true) && (true) && (true)) {
			match("/*?");
			{
			_loop548:
			do {
				boolean synPredMatched546 = false;
				if (((LA(1)=='/') && (LA(2)=='*') && ((LA(3) >= '\u0003' && LA(3) <= '\uffff')) && ((LA(4) >= '\u0003' && LA(4) <= '\uffff')) && ((LA(5) >= '\u0003' && LA(5) <= '\uffff')) && ((LA(6) >= '\u0003' && LA(6) <= '\uffff')) && ((LA(7) >= '\u0003' && LA(7) <= '\uffff')) && (true) && (true) && (true))) {
					int _m546 = mark();
...
inputState.guessing--;
				...
				else if (((LA(1)=='?') && (LA(2)=='*') && ((LA(3) >= '\u0003' && LA(3) <= '\uffff')) && ((LA(4) >= '\u0003' && LA(4) <= '\uffff')) && ((LA(5) >= '\u0003' && LA(5) <= '\uffff')) && (true) && (true) && (true) && (true) && (true))&&(LA(3)!='/' )) {
					match("?*");
				}
				else if ((_tokenSet_0.member(LA(1))) && ((LA(2) >= '\u0003' && LA(2) <= '\uffff')) && ((LA(3) >= '\u0003' && LA(3) <= '\uffff')) && ((LA(4) >= '\u0003' && LA(4) <= '\uffff')) && (true) && (true) && (true) && (true) && (true) && (true)) {
					{
					match(_tokenSet_0);
					}
				}
		...
		else if ((LA(1)=='/') && (LA(2)=='*') && ((LA(3) >= '\u0003' && LA(3) <= '\uffff')) && ((LA(4) >= '\u0003' && LA(4) <= '\uffff')) && (true) && (true) && (true) && (true) && (true) && (true)) {
			match("/*");
			{
			_loop543:
			do {
				boolean synPredMatched541 = false;
				if (((LA(1)=='/') && (LA(2)=='*') && ((LA(3) >= '\u0003' && LA(3) <= '\uffff')) && ((LA(4) >= '\u0003' && LA(4) <= '\uffff')) && ((LA(5) >= '\u0003' && LA(5) <= '\uffff')) && ((LA(6) >= '\u0003' && LA(6) <= '\uffff')) && (true) && (true) && (true) && (true))) {
					int _m541 = mark();
...
inputState.guessing--;
				...
				else if (((LA(1)=='*') && ((LA(2) >= '\u0003' && LA(2) <= '\uffff')) && ((LA(3) >= '\u0003' && LA(3) <= '\uffff')) && (true) && (true) && (true) && (true) && (true) && (true) && (true))&&( LA(2)!='/' )) {
					match('*');
				}
				else if ((_tokenSet_1.member(LA(1))) && ((LA(2) >= '\u0003' && LA(2) <= '\uffff')) && ((LA(3) >= '\u0003' && LA(3) <= '\uffff')) && (true) && (true) && (true) && (true) && (true) && (true) && (true)) {
					{
					match(_tokenSet_1);
					}
				}
	...
	protected final void mNEWLINE(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		...
		case '\r':
		{
			...
			match('\r');
			{
			if ((LA(1)=='\n') && ((LA(2) >= '\u0003' && LA(2) <= '\uffff')) && ((LA(3) >= '\u0003' && LA(3) <= '\uffff')) && (true) && (true) && (true) && (true) && (true) && (true) && (true)) {
				match('\n');
			}
			else if (((LA(1) >= '\u0003' && LA(1) <= '\uffff')) && ((LA(2) >= '\u0003' && LA(2) <= '\uffff')) && (true) && (true) && (true) && (true) && (true) && (true) && (true) && (true)) {
			}
			else {
				throw new NoViableAltForCharException((char)LA(1), getFilename(), getLine(), getColumn());
			}
