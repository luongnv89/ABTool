// $ANTLR 2.7.6 (2005-12-22): "expandedExpression.g" -> "ExpressionLexer.java"$
...
public class ExpressionLexer extends antlr.CharScanner implements ExpressionTokenTypes, TokenStream
 {
...
inputState.guessing--;
				...
				else if ((_tokenSet_0.member(LA(1))) && ((LA(2) >= '\u0003' && LA(2) <= '\uffff')) && ((LA(3) >= '\u0003' && LA(3) <= '\uffff')) && (true)) {
					{
					match(_tokenSet_0);
					}
				}
...
inputState.guessing--;
					...
					else if ((_tokenSet_1.member(LA(1))) && ((LA(2) >= '\u0003' && LA(2) <= '\uffff')) && ((LA(3) >= '\u0003' && LA(3) <= '\uffff')) && ((LA(4) >= '\u0003' && LA(4) <= '\uffff'))) {
						{
						match(_tokenSet_1);
						}
					}
