// $ANTLR 2.7.6 (2005-12-22): "expandedGeneralisedSubstitutionLanguage.g" -> "GeneralisedSubstitutionLanguageLexer.java"$
...
public class GeneralisedSubstitutionLanguageLexer extends antlr.CharScanner implements GeneralisedSubstitutionLanguageTokenTypes, TokenStream
 {
...
public GeneralisedSubstitutionLanguageLexer(InputStream in) {
	this(new ByteBuffer(in));
}
public GeneralisedSubstitutionLanguageLexer(Reader in) {
	this(new CharBuffer(in));
}
public GeneralisedSubstitutionLanguageLexer(InputBuffer ib) {
	this(new LexerSharedInputState(ib));
}
public GeneralisedSubstitutionLanguageLexer(LexerSharedInputState state) {
	super(state);
...
tryAgain:
	...
	public final void mGSL_SUCH(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
	...
	public final void mGSL_FOR_SUCH(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		int _ttype; Token _token=null; int _begin=text.length();
		_ttype = GSL_FOR_SUCH;
		int _saveIndex;
	...
	public final void mGSL_GUARD(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		int _ttype; Token _token=null; int _begin=text.length();
		_ttype = GSL_GUARD;
		int _saveIndex;
	...
	public final void mML_COMMENT(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		...
		if ((LA(1)=='/') && (LA(2)=='*') && (LA(3)=='?') && ((LA(4) >= '\u0003' && LA(4) <= '\uffff')) && ((LA(5) >= '\u0003' && LA(5) <= '\uffff'))) {
			...
			do {
				...
				else if (((LA(1)=='?') && (LA(2)=='*') && ((LA(3) >= '\u0003' && LA(3) <= '\uffff')) && ((LA(4) >= '\u0003' && LA(4) <= '\uffff')))&&( LA(3)!='/' )) {
					match("?*");
				}
				else if ((LA(1)=='\r') && ((LA(2) >= '\u0003' && LA(2) <= '\uffff')) && ((LA(3) >= '\u0003' && LA(3) <= '\uffff')) && ((LA(4) >= '\u0003' && LA(4) <= '\uffff')) && (true)) {
					match('\r');
					newline();
				}
				else if ((LA(1)=='\n')) {
		...
		else if ((LA(1)=='/') && (LA(2)=='*') && ((LA(3) >= '\u0003' && LA(3) <= '\uffff')) && ((LA(4) >= '\u0003' && LA(4) <= '\uffff')) && (true)) {
			match("/*");
			{
			_loop292:
			do {
