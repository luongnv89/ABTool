...
public interface EventTreeWalkerTokenTypes {
	int EOF = 1;
	...
	int SUBST_DEF = 185;
	int SUBST_TO = 186;
	int LITERAL_SYSTEM = 187;
	int LITERAL_EVENTS = 188;
	int LITERAL_MODALITIES = 189;
	int LITERAL_MAINTAIN = 190;
	int LITERAL_UNTIL = 191;
	int LITERAL_ESTABLISH = 192;
	int LITERAL_ALL = 193;
	int B_ref = 194;
	int LITERAL_POST = 195;
	int B_PREC = 196;
	int B_ANY_POST = 197;
	int B_SELECT_POST = 198;
	int B_PRE_POST = 199;
	int B_BEGIN_POST = 200;
	int LITERAL_ref = 201;
}
