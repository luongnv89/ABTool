// $ANTLR 2.7.6 (2005-12-22): "expandedBPrime.g" -> "BPrimeLexer.java"$
...
public class BPrimeLexer extends antlr.CharScanner implements BPrimeTokenTypes, TokenStream
 {
...
public BPrimeLexer(InputStream in) {
	this(new ByteBuffer(in));
}
public BPrimeLexer(Reader in) {
	this(new CharBuffer(in));
}
public BPrimeLexer(InputBuffer ib) {
	this(new LexerSharedInputState(ib));
}
public BPrimeLexer(LexerSharedInputState state) {
	super(state);
	...
	literals.put(new ANTLRHashString("POST", this), new Integer(187));
