...
}class BModelParser extends Parser;

options {
	importVocab= B;
	exportVocab= BModelLexer;
	k=7;
...
substitution_event :substitution_mch
	;
...
event_list :B_IDENTIFIER (b:"OR"^ B_IDENTIFIER)*
{
...
// Our Packages
    import ABTOOLS.DEBUGGING.*;
    import ABTOOLS.ANTLR_TOOLS.*;
}class BModelLexer extends Lexer;
